...
## [Beth (Bun, Elysia, Turso, HTMX)](https://www.youtube.com/watch?v=cpzowDDJj24) uses the following:
  ...
  * [HTMX - Data monipulation, client requests](https://htmx.org/examples/)
  * [JSX - Easy method of getting server data](https://react.dev/learn/javascript-in-jsx-with-curly-braces)
  * [Tailwind - CSS framework](https://tailwindui.com/documentation)
